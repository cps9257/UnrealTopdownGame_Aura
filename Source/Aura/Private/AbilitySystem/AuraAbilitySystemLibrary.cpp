...
bool UAuraAbilitySystemLibrary::TryGetWidgetControllerParams(const UObject* WorldContextObject, FWidgetControllerParams& OutWCParams,  AAuraHUD*& OutAuraHUD)
{
...
UOverlayWidgetController* UAuraAbilitySystemLibrary::GetOverlayWidgetController(const UObject* WorldContextObject)
{
	...
	if (TryGetWidgetControllerParams(WorldContextObject, WCParams, AuraHUD))
	{
