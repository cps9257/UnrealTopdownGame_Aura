...
void UAuraAttributeSet::SetEffectProperties(const FGameplayEffectModCallbackData& Data, FEffectProperties& Props) const
{
	...
	if(IsValid(Props.SourceASC) && Props.SourceASC->AbilityActorInfo.IsValid()&& Props.SourceASC->AbilityActorInfo->AvatarActor.IsValid())
	{
		...
		Props.SourceController = reinterpret_cast<AController*>(Props.SourceASC->AbilityActorInfo->PlayerController.Get());
	...
	if(Data.Target.AbilityActorInfo.IsValid() && Data.Target.AbilityActorInfo->AvatarActor.IsValid())
	{
		...
		Props.TargetController = reinterpret_cast<AController*>(Data.Target.AbilityActorInfo->PlayerController.Get());
